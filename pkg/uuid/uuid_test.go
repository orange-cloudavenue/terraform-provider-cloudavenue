...
// TestVcloudUUID_IsIsCertificateLibraryItem tests the IsCertificateLibraryItem function.
func TestVcloudUUID_IsCertificateLibraryItem(t *testing.T) {
	tests := []struct {
		name string
		uuid VcloudUUID
		want bool
		...
		{ // IsCertificateLibraryItem
			...
			uuid: VcloudUUID(CertificateLibraryItem.String() + validUUIDv4),
			want: true,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.uuid.IsCertificateLibraryItem(); got != tt.want {
				t.Errorf("VcloudUUID.IsCertificateLibraryItem() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIsCertificateLibraryItem(t *testing.T) {
	tests := []struct {
		...
		{ // IsCertificateLibraryItem
			name: "IsCertificateLibraryItem",
			uuid: VcloudUUID(CertificateLibraryItem.String() + validUUIDv4).String(),
			want: true,
		},
		{ // IsNotCertificateLibraryItem
			name: "IsNotCertificateLibraryItem",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := IsCertificateLibraryItem(tt.uuid); got != tt.want {
