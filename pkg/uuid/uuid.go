...
const (
	...
	CertificateLibraryItem = VcloudUUID(VcloudUUIDPrefix + "certificateLibraryItem:")
...
// IsCertificateLibraryItem returns true if the UUID is a CertificateLibraryItem UUID.
func (uuid VcloudUUID) IsCertificateLibraryItem() bool {
	return uuid.IsType(CertificateLibraryItem)
}
...
// IsCertificateLibraryItem returns true if the UUID is a CertificateLibraryItem UUID.
func IsCertificateLibraryItem(uuid string) bool {
	return VcloudUUID(uuid).IsType(CertificateLibraryItem)
}
