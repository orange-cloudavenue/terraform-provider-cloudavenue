...
replace github.com/orange-cloudavenue/terraform-plugin-framework-superschema => ../terraform-plugin-framework-superschema

replace github.com/orange-cloudavenue/terraform-plugin-framework-validators => ../terraform-plugin-framework-validators
