...
* deps: bumps github.com/hashicorp/terraform-plugin-log, github.com/orange-cloudavenue/cloudavenue-sdk-go from 0.10.0 to 0.11.0 (GH-1266)
...
* Fix panic in the authentication s3 method. (GH-1201)
