				...
				Updates: []testsacc.TFConfig{
					...
					// ? Update Action to send_response (11)
					{
						...
						Checks: []resource.TestCheckFunc{
							...
							resource.TestCheckResourceAttr(resourceName, "policies.0.actions.send_response.content", "ZXhhbXBsZQo="),
					...
					// ? Update Action to rate_limit with local_response (13)
					{
						...
						Checks: []resource.TestCheckFunc{
							...
							resource.TestCheckResourceAttr(resourceName, "policies.0.actions.rate_limit.local_response.content", "ZXhhbXBsZQo="),
				...
				Updates: []testsacc.TFConfig{
					...
					// ? Update criteria to 2 policies (18)
					{
						...
						Checks: []resource.TestCheckFunc{
							...
							resource.TestCheckResourceAttr(resourceName, "policies.1.actions.rate_limit.local_response.content", "ZXhhbXBsZQo="),
