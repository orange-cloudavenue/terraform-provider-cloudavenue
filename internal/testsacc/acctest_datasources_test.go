...
func GetDataSourceConfig() map[testsacc.ResourceName]func() *testsacc.ResourceConfig {
	return map[testsacc.ResourceName]func() *testsacc.ResourceConfig{
		...
		VDCGNetworkContextProfileDatasourceName: testsacc.NewResourceConfig(NewVDCGNetworkContextProfileDatasourceTest()),
		...
		EdgeGatewayNetworkContextProfileDatasourceName: testsacc.NewResourceConfig(NewEdgeGatewayNetworkContextProfileDatasourceTest()),
