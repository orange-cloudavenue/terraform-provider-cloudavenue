...
func GetDataSourceConfig() map[testsacc.ResourceName]func() *testsacc.ResourceConfig {
	return map[testsacc.ResourceName]func() *testsacc.ResourceConfig{
		...
		VDCStorageProfileDataSourceName:  testsacc.NewResourceConfig(NewVDCStorageProfileDataSourceTest()),
		VDCStorageProfilesDataSourceName: testsacc.NewResourceConfig(NewVDCStorageProfilesDataSourceTest()),

		// * VDC Group
		VDCGDataSourceName:                     testsacc.NewResourceConfig(NewVDCGDataSourceTest()),
		VDCGsDataSourceName:                    testsacc.NewResourceConfig(NewVDCGsDataSourceTest()),
