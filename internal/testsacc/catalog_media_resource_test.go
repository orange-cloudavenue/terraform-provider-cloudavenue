...
var _ testsacc.TestACC = &catalog_MediaResource{}

const (
	catalog_MediaResourceName = testsacc.ResourceName("cloudavenue_catalog_media")
)

type catalog_MediaResource struct{}

func Newcatalog_MediaResourceTest() testsacc.TestACC {
	return &catalog_MediaResource{}
}

// GetResourceName returns the name of the resource.
func (r *catalog_MediaResource) GetResourceName() string {
	return catalog_MediaResourceName.String()
}

func (r *catalog_MediaResource) DependenciesConfig() (resp testsacc.DependenciesConfigResponse) {
...
func (r *catalog_MediaResource) Tests(ctx context.Context) map[testsacc.TestName]func(ctx context.Context, resourceName string) testsacc.Test {
		...
		"example": func(_ context.Context, resourceName string) testsacc.Test {
			return testsacc.Test{
				...
				Create: testsacc.TFConfig{
					...
					resource "cloudavenue_catalog_media" "example" {
						foo = "bar"
					}`),
...
func TestAcccatalog_MediaResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { TestAccPreCheck(t) },
		ProtoV6ProviderFactories: TestAccProtoV6ProviderFactories,
		Steps:                    testsacc.GenerateTests(&catalog_MediaResource{}),
	})
}
