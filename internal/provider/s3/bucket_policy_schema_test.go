...
func TestBucketPolicyResourceSchema(t *testing.T) {
	...
	s3.NewBucketPolicyResource().Schema(ctx, fwresource.SchemaRequest{}, schemaResponse)
...
func TestBucketPolicyDataSourceSchema(t *testing.T) {
	...
	s3.NewBucketPolicyDataSource().Schema(ctx, fwdatasource.SchemaRequest{}, schemaResponse)
