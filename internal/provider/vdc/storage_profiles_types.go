...
type (
	storageProfilesDataSourceModel struct {
		...
		StorageProfiles supertypes.ListNestedObjectValueOf[storageProfilesDataSourceModelStorageProfile] `tfsdk:"storage_profiles"`
	}
	storageProfilesDataSourceModelStorageProfile struct {
		ID      supertypes.StringValue `tfsdk:"id"`
