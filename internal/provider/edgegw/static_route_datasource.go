...
func (d *staticRouteDataSource) Init(_ context.Context, dm *StaticRouteModel) (diags diag.Diagnostics) {
	var err error
...
func (d *staticRouteDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *staticRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	defer metrics.New("data.cloudavenue_edgegateway_static_route", d.client.GetOrgName(), metrics.Read)()
