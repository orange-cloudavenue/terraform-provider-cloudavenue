	...
	return superschema.Schema{
		DataSource: superschema.SchemaDetails{
			...
			Deprecated: superschema.DeprecatedResource{
				...
				TargetRelease:                     "v0.39.0",
				LinkToMilestone:                   "https://github.com/orange-cloudavenue/terraform-provider-cloudavenue/milestone/27",
				LinkToIssue:                       "https://github.com/orange-cloudavenue/terraform-provider-cloudavenue/issues/1163",
