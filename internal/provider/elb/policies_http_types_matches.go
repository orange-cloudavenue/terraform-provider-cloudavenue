...
// // policiesHTTPHeaderMatchToSDK converts the terraform model to the SDK model.
// func policiesHTTPHeaderMatchToSDK(ctx context.Context, diags diag.Diagnostics, s supertypes.SingleNestedObjectValueOf[PoliciesHTTPHeaderMatch]) *edgeloadbalancer.PoliciesHTTPHeaderMatch {
// 	if !s.IsKnown() {
// 		return nil
// 	}
...
// 	return &edgeloadbalancer.PoliciesHTTPHeaderMatch{
// 		Criteria: v.Criteria.Get(),
// 		Name:     v.Name.Get(),
...
// // policiesHTTPHeaderMatchFromSDK converts the SDK model to the terraform model.
// func policiesHTTPHeaderMatchFromSDK(ctx context.Context, v edgeloadbalancer.PoliciesHTTPHeadersMatch) supertypes.SetNestedObjectValueOf[PoliciesHTTPHeaderMatch] {
