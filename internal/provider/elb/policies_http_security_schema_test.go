...
func TestPoliciesHTTPSecurityResourceSchema(t *testing.T) {
	...
	elb.NewPoliciesHTTPSecurityResource().Schema(ctx, fwresource.SchemaRequest{}, schemaResponse)
...
func TestPoliciesHTTPSecurityDataSourceSchema(t *testing.T) {
	...
	elb.NewPoliciesHTTPSecurityDataSource().Schema(ctx, fwdatasource.SchemaRequest{}, schemaResponse)
