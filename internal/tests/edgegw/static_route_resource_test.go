...
func TestAccStaticRouteResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				// Apply test
				Config: tests.ConcatTests(testAccEdgeGatewayResourceConfig, testAccStaticRouteResourceConfig),
				Check:  staticRouteTestCheck(resourceName),
			},
			// Update testing
			{
				// Update test
				Config: tests.ConcatTests(testAccEdgeGatewayResourceConfig, testAccStaticRouteResourceConfigUpdate),
			...
			{
				// Apply test
				Config: tests.ConcatTests(testAccEdgeGatewayGroupResourceConfig, testAccStaticRouteResourceConfigWithVDCGroup),
				Check:  staticRouteTestCheck(resourceName),
			},
			// Update testing
			{
				// Update test
				Config: tests.ConcatTests(testAccEdgeGatewayGroupResourceConfig, testAccStaticRouteResourceConfigUpdateWithVDCGroup),
				Check:  staticRouteTestCheckUpdated(resourceName),
			},
			// Import State testing
			{
