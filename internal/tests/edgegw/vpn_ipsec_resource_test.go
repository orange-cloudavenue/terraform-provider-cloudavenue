...
func TestAccVPNIPSecResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				// Apply test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayResourceConfig, testAccVPNIPSecResourceConfigDefault),
				// Config: testAccVPNIPSecResourceConfigDefault,
				Check: vpnIPSecTestCheckDefault(resourceName),
			},
			{
				// Update test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayResourceConfig, testAccVPNIPSecResourceConfigDefaultUpdate),
			...
			{
				// Apply test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayResourceConfig, testAccVPNIPSecResourceConfigCustomize),
				Check:  vpnIPSecTestCheckCustomize(resourceName),
			},
			{
				// Update test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayResourceConfig, testAccVPNIPSecResourceConfigCustomizeUpdate),
			...
			{
				// Apply test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayGroupResourceConfig, testAccVPNIPSecResourceConfigDefault),
				Check:  vpnIPSecTestCheckDefault(resourceName),
			},
			{
				// Update test
				Config: tests.ConcatTests(MytestAccVDCResourceConfig, MytestAccEdgeGatewayGroupResourceConfig, testAccVPNIPSecResourceConfigDefaultUpdate),
				Check:  vpnIPSecTestCheckDefaultUpdate(resourceName),
			},
			{
				// Delete test
