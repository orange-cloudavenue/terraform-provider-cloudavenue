...
func TestAccGroupResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				// Apply test
				Config: tests.ConcatTests(TestAccVDCResourceConfigWithoutVDCGroup, TestAccGroupResourceConfig),
				Check:  groupTestCheck(resourceName),
			},
			// Update testing
			{
				// Update test
				Config: tests.ConcatTests(TestAccVDCResourceConfigWithoutVDCGroup, TestAccGroupResourceConfigUpdate),
