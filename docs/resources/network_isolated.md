...
- `metadata_entry` (Attributes Set) A set of metadata entries to be used for this network. (see [below for nested schema](#nestedatt--metadata_entry))
...
<a id="nestedatt--metadata_entry"></a>
### Nested Schema for `metadata_entry`

Optional:

- `key` (String) The key of the metadata entry. This value must be a valid key.
- `type` (String) The type of the metadata entry. This value must be a value of: MetadataStringValue, MetadataNumberValue, MetadataDateTimeValue, MetadataBooleanValue.
- `user_access` (String) The user access of the metadata entry. This value must be a value of: PRIVATE, READONLY, READWRITE.
- `value` (String) The value of the metadata entry. This value must be a valid value.
