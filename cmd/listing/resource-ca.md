...
- Found 42 resources in terraform
...
| (13) | cloudavenue_edgegateway_vpn_ipsec |
...
| (21) | cloudavenue_publicip |
| (22) | cloudavenue_s3_bucket |
| (23) | cloudavenue_s3_bucket_acl |
| (24) | cloudavenue_s3_bucket_cors_configuration |
| (25) | cloudavenue_s3_bucket_lifecycle_configuration |
| (26) | cloudavenue_s3_bucket_policy |
| (27) | cloudavenue_s3_bucket_versioning_configuration |
| (28) | cloudavenue_s3_bucket_website_configuration |
| (29) | cloudavenue_s3_credential |
| (30) | cloudavenue_vapp | vcd_vapp |
| (31) | cloudavenue_vapp_acl | vcd_vapp_access_control |
| (32) | cloudavenue_vapp_isolated_network | vcd_vapp_network |
| (33) | cloudavenue_vapp_org_network | vcd_vapp_org_network |
| (34) | cloudavenue_vcda_ip |
| (35) | cloudavenue_vdc | vcd_org_vdc |
| (36) | cloudavenue_vdc_acl | vcd_org_vdc_access_control |
| (37) | cloudavenue_vdc_group | vcd_vdc_group |
| (38) | cloudavenue_vm | vcd_vm |
| (39) | cloudavenue_vm_affinity_rule | vcd_vm_affinity_rule |
| (40) | cloudavenue_vm_disk | vcd_independent_disk |
| (41) | cloudavenue_vm_inserted_media | vcd_inserted_media |
| (42) | cloudavenue_vm_security_tag | vcd_security_tag |
...
| (18) | cloudavenue_edgegateway_vpn_ipsec |
...
|:--:|:--:|:--:|:--:|
| (1) | vcd_api_filter | Not yet implemented | :x: |
| (2) | vcd_api_token | Not yet implemented | :x: |
| (3) | vcd_catalog | cloudavenue_catalog |:white_check_mark: |
| (4) | vcd_catalog_access_control | Not yet implemented | :x: |
...
| (9) | vcd_cse_kubernetes_cluster | Not yet implemented | :x: |
| (10) | vcd_dse_registry_configuration | Not yet implemented | :x: |
| (11) | vcd_dse_solution_publish | Not yet implemented | :x: |
...
| (15) | vcd_external_endpoint | Not yet implemented | :x: |
...
| (30) | vcd_library_certificate | Not yet implemented | :x: |
| (31) | vcd_multisite_org_association | Not yet implemented | :x: |
| (32) | vcd_multisite_site_association | Not yet implemented | :x: |
...
| (36) | vcd_network_pool | Not yet implemented | :x: |
...
| (64) | vcd_nsxt_global_default_segment_profile_template | Not yet implemented | :x: |
| (65) | vcd_nsxt_ip_set | cloudavenue_edgegateway_ip_set | :white_check_mark: |
| (66) | vcd_nsxt_ipsec_vpn_tunnel | Not yet implemented | :x: |
...
| (71) | vcd_nsxt_network_segment_profile | Not yet implemented | :x: |
...
| (74) | vcd_nsxt_segment_profile_template | Not yet implemented | :x: |
...
| (89) | vcd_org_vdc_nsxt_network_profile | Not yet implemented | :x: |
| (90) | vcd_org_vdc_template | Not yet implemented | :x: |
| (91) | vcd_org_vdc_template_instance | Not yet implemented | :x: |
...
| (102) | vcd_service_account | Not yet implemented | :x: |
| (103) | vcd_solution_add_on | Not yet implemented | :x: |
| (104) | vcd_solution_add_on_instance | Not yet implemented | :x: |
| (105) | vcd_solution_add_on_instance_publish | Not yet implemented | :x: |
| (106) | vcd_solution_landing_zone | Not yet implemented | :x: |
...
| (111) | vcd_vapp_firewall_rules | Not yet implemented | :x: |
| (112) | vcd_vapp_nat_rules | Not yet implemented | :x: |
...
| (115) | vcd_vapp_static_routing | Not yet implemented | :x: |
...
| (123) | vcd_vm_vgpu_policy | Not yet implemented | :x: |
...
| (7) | vcd_cse_kubernetes_cluster | Not yet implemented | :x: |
| (8) | vcd_dse_registry_configuration | Not yet implemented | :x: |
| (9) | vcd_dse_solution_publish | Not yet implemented | :x: |
| (10) | vcd_edgegateway | Not Applicable | :heavy_multiplication_x: |
| (11) | vcd_external_endpoint | Not yet implemented | :x: |
...
| (28) | vcd_multisite_site | Not yet implemented | :x: |
| (29) | vcd_multisite_site_association | Not yet implemented | :x: |
| (30) | vcd_multisite_site_data | Not yet implemented | :x: |
...
| (34) | vcd_network_pool | Not yet implemented | :x: |
...
| (65) | vcd_nsxt_global_default_segment_profile_template | Not yet implemented | :x: |
| (66) | vcd_nsxt_ip_set | cloudavenue_edgegateway_ip_set | :white_check_mark: |
| (67) | vcd_nsxt_ipsec_vpn_tunnel | Not yet implemented | :x: |
...
| (70) | vcd_nsxt_network_context_profile | Not yet implemented | :x: |
...
| (74) | vcd_nsxt_network_segment_profile | Not yet implemented | :x: |
...
| (77) | vcd_nsxt_segment_ip_discovery_profile | Not yet implemented | :x: |
| (78) | vcd_nsxt_segment_mac_discovery_profile | Not yet implemented | :x: |
| (79) | vcd_nsxt_segment_profile_template | Not yet implemented | :x: |
| (80) | vcd_nsxt_segment_qos_profile | Not yet implemented | :x: |
| (81) | vcd_nsxt_segment_security_profile | Not yet implemented | :x: |
| (82) | vcd_nsxt_segment_spoof_guard_profile | Not yet implemented | :x: |
| (83) | vcd_nsxt_tier0_router | Not Applicable | :heavy_multiplication_x: |
| (84) | vcd_nsxt_tier0_router_interface | Not yet implemented | :x: |
...
| (102) | vcd_org_vdc_nsxt_network_profile | Not yet implemented | :x: |
| (103) | vcd_org_vdc_template | Not yet implemented | :x: |
| (104) | vcd_portgroup | Not yet implemented | :x: |
| (105) | vcd_provider_vdc | Not Applicable | :heavy_multiplication_x: |
| (106) | vcd_rde | Not Applicable | :heavy_multiplication_x: |
| (107) | vcd_rde_behavior_invocation | Not yet implemented | :x: |
...
| (119) | vcd_service_account | Not yet implemented | :x: |
| (120) | vcd_solution_add_on | Not yet implemented | :x: |
| (121) | vcd_solution_add_on_instance | Not yet implemented | :x: |
| (122) | vcd_solution_add_on_instance_publish | Not yet implemented | :x: |
| (123) | vcd_solution_landing_zone | Not yet implemented | :x: |
...
| (126) | vcd_task | Not yet implemented | :x: |
...
| (141) | vcd_vm_vgpu_policy | Not yet implemented | :x: |
