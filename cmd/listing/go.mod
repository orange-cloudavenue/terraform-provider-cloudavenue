...
require (
	...
	github.com/FrangipaneTeam/terraform-plugin-framework-superschema v1.8.1 // indirect
	...
	github.com/orange-cloudavenue/cloudavenue-sdk-go v0.18.0 // indirect
	...
	github.com/vmware/go-vcloud-director/v2 v2.26.1 // indirect
